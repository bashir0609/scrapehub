...
urlpatterns = [
    ...
    path('api/<str:job_id>/results/', views.job_results_api, name='job_results_api'),
    path('api/<str:job_id>/download/', views.download_job_results, name='download_job_results'),
